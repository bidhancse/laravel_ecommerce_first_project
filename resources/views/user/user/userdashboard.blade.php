		...
		<div class="row">
			...
			<div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12 mt-4" >
				<div class="col-md-12 p-0 pt-4 pb-4 userdashboard" style="border-top: 1px solid #ddd;">
					...
					<div class="mt-4" >
						<li class=" active "><a href="{{url('userdashboard')}}" style="text-decoration:none;"><i class="fa fa-tachometer" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Dashboard</a></li>
					...
					<div class="row">
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt-4">
							<div class="dash p-3 bg-info">
								...
								<a href="{{url('allorder')}}" style="text-decoration:none;">Total Order</a>
								@endif
							</div>
						</div>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt-4">
							<div class="dash p-3 bg-danger">
								@if(isset($PandingOrder))
								<label>{{count($PandingOrder)}}</label><br>
								<a href="{{url('allorder')}}" style="text-decoration:none;">Pending Order</a>
								@endif
							</div>
						</div>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt-4">
							<div class="dash p-3 bg-warning">
								...
								<label>{{count($ProcessingOrder)}}</label><br>
								<a href="{{url('allorder')}}" style="text-decoration:none;">Processing Order</a>
								@endif
							</div>
						</div>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 mt-4">
							<div class="dash p-3 bg-success">
								...
								<label>{{count($DeliveredOrder)}}</label><br>
								<a href="{{url('allorder')}}" style="text-decoration:none;">Delivered Order</a>
								@endif
							</div>
						</div>
