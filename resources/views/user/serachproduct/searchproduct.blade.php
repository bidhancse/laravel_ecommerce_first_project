	...
	<div class="container-fluid">
		<div class="col-sm-12 col-12 p-0">
			<div class="row" id="showproduct-130">
				...
				@foreach($productsearch as $searchProductview)

				<div class="col-lg-2 cl-md-4 col-sm-6 col-6 mt-4" >
					<div class="homeproducts border">
						@php
						$dis_percentig = $searchProductview->discount_price / $searchProductview->sale_price*100;
						@endphp

						@if(isset($searchProductview->discount_price))
						...
						@endif
						<center>
							<a href="{{url('product/'.$searchProductview->id)}}"><img src="{{ url($searchProductview->image) }}" class="img-fluid" style="z-index:1; "></a>
						</center>
						<div>
							<a href="{{url('product/'.$searchProductview->id)}}"><center>
								@php
								$content = substr($searchProductview->product_name,0,20);
								$sale_price = $searchProductview->sale_price;
								$dis_price = $searchProductview->discount_price;
								...
								<span style="font-size: 15px;">
									@if(isset($dis_price))
									<del>{{$searchProductview->sale_price}}</del> &nbsp;&nbsp;
									@endif
